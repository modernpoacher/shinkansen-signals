...
exports.boiler = exports.BOILER = undefined;
...
var boiler = exports.boiler = new _map2.default();

(0, _ownKeys2.default)(BOILER).forEach(function (key) {
  boiler.set(key, (0, _get2.default)(BOILER, key));
});