...
exports.signals = exports.SIGNALS = undefined;
...
var signals = exports.signals = new _map2.default();

(0, _ownKeys2.default)(SIGNALS).forEach(function (key) {
  signals.set(key, (0, _get2.default)(SIGNALS, key));
});